...
@section('content')
    ...
    <section class="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0 parallax-bg">
            <img src="https://images.unsplash.com/photo-1551632811-561732d1e306?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                alt="LokaVation Digital Services"
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <h1 class="text-5xl md:text-7xl font-bold mb-6 animate-fade-in leading-tight">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-accent">Layanan</span>
                Digital Terpadu
            </h1>

            <p class="text-xl md:text-2xl mb-12 max-w-4xl mx-auto animate-fade-in-delay text-gray-200 leading-relaxed">
                Kami menyediakan <span class="text-secondary font-semibold">ekosistem digital lengkap</span> untuk mendukung
                setiap tahap pertumbuhan destinasi wisata Anda dengan <span class="text-accent font-semibold">teknologi
                    terdepan</span>.
            </p>
            ...
            <div class="flex flex-wrap justify-center items-center gap-8 text-white/80 animate-fade-in-delay-3">
                <div class="flex items-center">
                    ...
                    <span class="text-sm font-medium">3 Paket Layanan Lengkap</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 text-secondary mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                    ...
                    <span class="text-sm font-medium">Teknologi Terdepan</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-5 h-5 text-secondary mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                    ...
                    <span class="text-sm font-medium">Support Berkelanjutan</span>
                </div>
            </div>
        </div>
        ...
        <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce cursor-pointer"
            onclick="document.querySelector('#services-detail').scrollIntoView({behavior: 'smooth'})">
            <div class="flex flex-col items-center text-white/80 hover:text-white transition-colors duration-300">
                <span class="text-sm font-medium mb-2">Jelajahi Layanan</span>
    ...
    <section id="services-detail" class="py-24 bg-white relative overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-20 animate-on-scroll">
                ...
                <h2 class="text-4xl md:text-5xl font-bold text-text mb-6 leading-tight">
                    Layanan Digital Lengkap dari
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">LokaVation</span>
                </h2>
            ...
            <div class="space-y-32">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div class="lg:col-span-6 animate-on-scroll">
                        <div class="relative">
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-10 border border-blue-200">
                    ...
                    <div class="lg:col-span-6 order-1 lg:order-2 animate-on-scroll">
                        <div class="relative">
                            ...
                            <div
                                ...
                                <a href="#contact"
                                    class="inline-flex items-center bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 group">
                                    Konsultasi Gratis
                                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-300"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <!-- Service 3 - Digital Marketing Training -->
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div class="lg:col-span-6 animate-on-scroll">
                        <div class="relative">
                            <div
                                class="absolute -top-6 -left-6 w-12 h-12 bg-gradient-to-br from-green-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-lg">
                                <span class="text-white font-bold text-xl">03</span>
                            </div>
                            <div
                                class="bg-gradient-to-br from-green-50 to-teal-50 rounded-3xl p-10 border border-green-200">
                                <div class="flex items-center mb-8">
                                    <div
                                        class="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-500 rounded-2xl flex items-center justify-center mr-4">
                                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <h3 class="text-3xl font-bold text-text">Pelatihan Digital Marketing</h3>
                                </div>
                                <p class="text-lg text-gray-700 mb-8 leading-relaxed">
                                    Program pelatihan komprehensif untuk tim lokal agar mandiri dalam mengelola promosi
                                    digital dan mengoptimalkan kehadiran online.
                                </p>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                                    ...
                                    <div class="flex items-center bg-white rounded-lg p-4 shadow-sm">
                                        ...
                                        <span class="text-gray-700 font-medium">SEO Training</span>
                                    </div>
                                    <div class="flex items-center bg-white rounded-lg p-4 shadow-sm">
                                        <svg class="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="currentColor"
                                            viewBox="0 0 20 20">
                                        ...
                                        <span class="text-gray-700 font-medium">Analytics & Reporting</span>
                                    </div>
                                </div>

                                <a href="#contact"
                                    class="inline-flex items-center bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 group">
                                    Daftar Pelatihan
                                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-300"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="lg:col-span-6 animate-on-scroll">
                        <div class="relative">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-green-500/20 to-teal-500/20 rounded-3xl blur-xl">
                            </div>
                            <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2015&q=80"
    ...
    <section class="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-20 animate-on-scroll">
                ...
                <h2 class="text-4xl md:text-5xl font-bold text-text mb-6 leading-tight">
                    Proses Kerja
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-accent to-primary">Terpadu</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                    Metodologi yang teruji untuk memastikan hasil terbaik bagi destinasi wisata Anda dengan pendekatan yang
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center animate-on-scroll group">
                    <div class="relative mb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-primary to-primary-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg group-hover:shadow-2xl transition-shadow duration-300">
                            <span class="text-white font-bold text-2xl">1</span>
                        </div>
                        <div class="absolute -top-2 -right-2 w-6 h-6 bg-secondary rounded-full animate-pulse"></div>
                    </div>
                    <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Memahami potensi, tantangan, dan target yang ingin dicapai destinasi Anda melalui assessment
                            mendalam.
                        </p>
                    </div>
                </div>
                ...
                <div class="text-center animate-on-scroll group">
                    <div class="relative mb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-secondary to-secondary-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg group-hover:shadow-2xl transition-shadow duration-300">
                            <span class="text-white font-bold text-2xl">2</span>
                        </div>
                        <div class="absolute -top-2 -right-2 w-6 h-6 bg-accent rounded-full animate-pulse"
                            style="animation-delay: 0.5s;"></div>
                    </div>
                    <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <h3 class="text-xl font-bold text-text mb-4">Perencanaan Strategi</h3>
                        <p class="text-gray-600 leading-relaxed">
                            Merancang roadmap digital yang sesuai dengan karakteristik dan budget Anda dengan timeline yang
                            jelas.
                        </p>
                    </div>
                </div>
                ...
                <div class="text-center animate-on-scroll group">
                    <div class="relative mb-8">
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-accent to-accent-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg group-hover:shadow-2xl transition-shadow duration-300">
                            <span class="text-white font-bold text-2xl">3</span>
                        </div>
                        <div class="absolute -top-2 -right-2 w-6 h-6 bg-primary rounded-full animate-pulse"
                            style="animation-delay: 1s;"></div>
                    </div>
                    <div class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <h3 class="text-xl font-bold text-text mb-4">Implementasi</h3>
                        <p class="text-gray-600 leading-relaxed">
                            Mengembangkan dan meluncurkan solusi digital dengan standar profesional dan quality assurance.
                        </p>
                    </div>
                </div>
                ...
                <div class="text-center animate-on-scroll group">
                    <div class="relative mb-8">
                        ...
                        <div class="absolute -top-2 -right-2 w-6 h-6 bg-secondary rounded-full animate-pulse"
            ...
            <!-- Process Flow Connector (Hidden on mobile) -->
            <div
                class="hidden lg:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl">
                <svg class="w-full h-8" viewBox="0 0 800 32" fill="none">
                    <path d="M0 16 L200 16 M200 16 L400 16 M400 16 L600 16 M600 16 L800 16" stroke="url(#gradient)"
                        stroke-width="2" stroke-dasharray="8,8" opacity="0.3">
                        <animate attributeName="stroke-dashoffset" values="16;0" dur="2s"
    ...
    <section class="py-24 bg-white relative overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-5">
            ...
            <div class="absolute bottom-20 left-20 w-72 h-72 bg-primary rounded-full blur-3xl"></div>
        </div>

        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-20 animate-on-scroll">
                <div
                    class="inline-flex items-center px-4 py-2 bg-secondary/10 text-secondary-700 rounded-full text-sm font-medium mb-6">
                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                ...
                <h2 class="text-4xl md:text-5xl font-bold text-text mb-6 leading-tight">
                    Mengapa Memilih
                    <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-accent">LokaVation?</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                    Pengalaman dan dedikasi kami dalam mengembangkan pariwisata lokal Indonesia dengan pendekatan yang
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold text-text mb-4 text-center">Solusi Inovatif</h3>
                    <p class="text-gray-700 leading-relaxed text-center">
                        Menggunakan teknologi terdepan yang disesuaikan dengan kebutuhan lokal Indonesia untuk memberikan
                        hasil optimal.
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold text-text mb-4 text-center">Tim Berpengalaman</h3>
                    <p class="text-gray-700 leading-relaxed text-center">
                        Didukung oleh tim ahli dengan track record sukses di industri pariwisata digital dan pemberdayaan
                        komunitas lokal.
                    </p>
                </div>
                ...
                <!-- Advantage 3 -->
                <div
                    class="group bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl p-8 border border-orange-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll">
                    <div
                    ...
                    <h3 class="text-xl font-bold text-text mb-4 text-center">Support Berkelanjutan</h3>
                    <p class="text-gray-700 leading-relaxed text-center">
                        Komitmen jangka panjang dengan pendampingan berkelanjutan untuk memastikan kesuksesan transformasi
                        digital Anda.
                    </p>
                </div>
                ...
                <div
                    ...
                    <h3 class="text-xl font-bold text-text mb-4 text-center">Harga Terjangkau</h3>
                    <p class="text-gray-700 leading-relaxed text-center">
                        Paket layanan yang fleksibel dan terjangkau, disesuaikan dengan budget dan kebutuhan destinasi
                        wisata Anda.
                    </p>
                </div>
                ...
                <!-- Advantage 5 -->
                <div
                    class="group bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-3xl p-8 border border-indigo-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <h3 class="text-xl font-bold text-text mb-4 text-center">Kualitas Terjamin</h3>
                    <p class="text-gray-700 leading-relaxed text-center">
                        Standar kualitas internasional dengan sertifikasi dan garansi untuk memastikan kepuasan dan hasil
                        yang maksimal.
                    </p>
                </div>
                ...
                <!-- Advantage 6 -->
                <div
                    class="group bg-gradient-to-br from-pink-50 to-pink-100 rounded-3xl p-8 border border-pink-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-on-scroll">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m-8 0h8m-8 0H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1M9 12l2 2 4-4">
                            </path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-text mb-4 text-center">Metodologi Proven</h3>
                    <p class="text-gray-700 leading-relaxed text-center">
                        Menggunakan metodologi yang telah terbukti sukses dalam mengembangkan 50+ destinasi wisata di
                        seluruh Indonesia.
                    </p>
                </div>
            </div>
